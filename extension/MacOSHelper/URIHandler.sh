...
aseprite --script-param fromURI=$1 --script "/Users/$USER/Library/Application Support/Aseprite/extensions/lospec-palette-importer/lpihelper.lua" || aseprite --script-param fromURI=$1 --script "/Users/$USER/Library/Application Support/Steam/steamapps/common/Aseprite/data/extensions/lospec-palette-importer/lpihelper.lua" && exit
